...
header.wrap{{padding:56px 20px 30px}} header p{{font-size:18px;color:var(--mute);margin:0;max-width:620px}}
...
@media(max-width:560px){{
 .wrap{{padding:0 18px}}
 header.wrap{{padding:48px 18px 24px}} .kicker{{margin-bottom:14px}}
